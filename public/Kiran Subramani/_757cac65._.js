...
function TopNav() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopNav.useEffect": ()=>{
            const onScroll = {
                "TopNav.useEffect.onScroll": ()=>setScrolled(window.scrollY > 10)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopNav.useEffect": ()=>{
            const ids = links.map({
                "TopNav.useEffect.ids": (l)=>l.id
            }["TopNav.useEffect.ids"]);
            const sections = ids.map({
                "TopNav.useEffect.sections": (id)=>document.getElementById(id)
            }["TopNav.useEffect.sections"]).filter(Boolean);
            if (!sections.length) return;
            const io = new IntersectionObserver({
                "TopNav.useEffect": (entries)=>{
                    const visible = entries.filter({
                        "TopNav.useEffect": (e)=>e.isIntersecting
                    }["TopNav.useEffect"]).sort({
                        "TopNav.useEffect": (a, b)=>(b.intersectionRatio ?? 0) - (a.intersectionRatio ?? 0)
                    }["TopNav.useEffect"])[0];
            ...
            sections.forEach({
                "TopNav.useEffect": (s)=>io.observe(s)
            }["TopNav.useEffect"]);
            return ({
                "TopNav.useEffect": ()=>io.disconnect()
            })["TopNav.useEffect"];
        }
    }["TopNav.useEffect"], [
        links
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        ...
        children: [
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "absolute -bottom-1 left-0 h-0.5 w-0 bg-gradient-to-r from-indigo-500 to-emerald-500 transition-all group-hover:w-full"
                                            }, void 0, false, {
                                                fileName: "[project]/components/TopNav.jsx",
                                                lineNumber: 87,
                                                columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "hidden text-xs font-semibold text-slate-500 md:inline",
                                        children: "• SWE"
                                    }, void 0, false, {
                                        fileName: "[project]/components/TopNav.jsx",
                                        lineNumber: 89,
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            isActive && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "absolute inset-0 -z-10 rounded-full bg-slate-900/5 ring-1 ring-slate-200/60"
                                            }, void 0, false, {
                                                fileName: "[project]/components/TopNav.jsx",
                                                lineNumber: 111,
                                                columnNumber: 23
            ...
            open && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "border-b border-slate-200/60 bg-white/80 backdrop-blur-xl md:hidden",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Container$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "py-4",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                links.map((l)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: [
                                            ...
                                            isActive ? "border-slate-200 bg-slate-900/5 text-slate-900" : "border-slate-200/60 bg-white/70 text-slate-700 hover:bg-white"
                                        ].join(" "),
                                        children: [
                                            l.label,
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(TopNav, "+0b/6CehOn9uUAfBnHMLHLOsRso=");
_c = TopNav;
var _c;
...
"[project]/components/AnimatedText.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function AnimatedText({ text = "", speed = 55, pause = 1200, loop = true, className = "" }) {
    _s();
    const chars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnimatedText.useMemo[chars]": ()=>String(text)
    }["AnimatedText.useMemo[chars]"], [
        text
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimatedText.useEffect": ()=>{
            ...
            if (!deleting) {
                if (i < chars.length) {
                    t = setTimeout({
                        "AnimatedText.useEffect": ()=>setI({
                                "AnimatedText.useEffect": (v)=>v + 1
                            }["AnimatedText.useEffect"])
                    }["AnimatedText.useEffect"], speed);
                } else {
                    // reached end
                    if (!loop) return;
                    t = setTimeout({
                        "AnimatedText.useEffect": ()=>setDeleting(true)
                    }["AnimatedText.useEffect"], pause);
                }
            } else {
                // deleting backward
                if (i > 0) {
                    ...
                    }["AnimatedText.useEffect"], Math.max(25, speed - 20));
                } else {
                    t = setTimeout({
                        "AnimatedText.useEffect": ()=>setDeleting(false)
                    }["AnimatedText.useEffect"], 250);
                }
            }
            return ({
                "AnimatedText.useEffect": ()=>clearTimeout(t)
            })["AnimatedText.useEffect"];
        }
    }["AnimatedText.useEffect"], [
        chars,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        ...
        children: [
            chars.slice(0, i),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: "inline-block w-[10px] align-baseline animate-pulse",
                children: "|"
            }, void 0, false, {
                fileName: "[project]/components/AnimatedText.jsx",
                lineNumber: 45,
                columnNumber: 7
            }, this)
        ]
...
_s(AnimatedText, "PN4Ex2RBp3fpZcufedXGemv0Irw=");
_c = AnimatedText;
var _c;
...
//# sourceMappingURL=_757cac65._.js.map