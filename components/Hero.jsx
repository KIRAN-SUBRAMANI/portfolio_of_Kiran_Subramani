        ...
        <div className="grid gap-10 lg:grid-cols-2 items-center py-16 lg:py-20">
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/70 px-4 py-2 text-sm text-slate-700 shadow-sm backdrop-blur">
              ...
              Available for Full Stack • AI Systems • Distributed Systems
            </div>
            ...
            <p className="mt-8 text-2xl sm:text-3xl font-extrabold tracking-tight">
              <span className="text-emerald-700">I build scalable healthcare systems,</span>{" "}
              <span className="text-slate-900">fintech microservices, and AI-powered pipelines.</span>
            </p>

            <p className="mt-4 max-w-xl text-lg text-slate-600 leading-relaxed">
              Focused on microservices, event-driven systems, and AI-powered applications using Java, Spring Boot, Kafka, React.js, and AWS.
            </p>

            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="card-premium rounded-2xl border border-slate-200 bg-white/80 backdrop-blur px-5 py-4">
                <div className="text-xs tracking-widest text-slate-500 font-semibold">LATENCY</div>
                <div className="mt-2 text-lg font-bold text-slate-900">38% API improvement</div>
              </div>
              <div className="card-premium rounded-2xl border border-slate-200 bg-white/80 backdrop-blur px-5 py-4">
              ...
              <div className="card-premium rounded-2xl border border-slate-200 bg-white/80 backdrop-blur px-5 py-4">
                ...
                <div className="mt-2 text-lg font-bold text-slate-900">60% deployment reduction</div>
              </div>
            </div>
            ...
            <div className="gradient-frame">
              <div className="card-premium rounded-[25px] border border-white/60 bg-white/85 backdrop-blur-xl p-7">
                ...
                <div className="mt-6 space-y-4">
                  {[
                    ["Full Stack", "Java + Spring Boot + React.js + Node.js", "Active", "bg-blue-50 text-blue-700 border-blue-100"],
                    ["AI Systems", "RAG + OpenAI APIs + LLM Pipelines", "Active", "bg-purple-50 text-purple-700 border-purple-100"],
                    ["Data Streaming", "Kafka + Redis + Real-time Events", "Active", "bg-emerald-50 text-emerald-700 border-emerald-100"],
                    ["Cloud & Infra", "AWS EKS + Docker + Kubernetes", "Active", "bg-orange-50 text-orange-700 border-orange-100"],
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <div className="card-premium rounded-2xl border border-slate-200 bg-white/70 px-5 py-4">
                    <div className="text-xs text-slate-500 font-semibold">Latency</div>
                    <div className="mt-2 text-xl font-extrabold text-slate-900">38% faster</div>
                  </div>
                  <div className="card-premium rounded-2xl border border-slate-200 bg-white/70 px-5 py-4">
                  ...
                  <div className="card-premium rounded-2xl border border-slate-200 bg-white/70 px-5 py-4">
                    ...
                    <div className="mt-2 text-xl font-extrabold text-slate-900">60% saved</div>
                  </div>
                  <div className="card-premium rounded-2xl border border-slate-200 bg-white/70 px-5 py-4">
